 ...
 * @author snowgoose
 */
public class MultipartParametersTypeMapperTest extends MultipartParametersTypeMapper {
    ...
    public void testTypeWithStream() throws Exception {
        ...
        InputStream actual = (InputStream) typeMapper.mapToType(context, multipartFile,
    ...
    public void testTypeWithFile() throws Exception {
        ...
        try {
            ...
            File actual = (File) typeMapper.mapToType(context, multipartFile, File.class, null);
    ...
    public void testTypeWithListOfFile() throws Exception {
        ...
        try {
            ...
            File actual = (File) typeMapper.mapToType(context, Arrays.asList(multipartFile),
                    File.class, null);
            assertThat(readLine(actual), is(readLine(file)));
        } finally {
            ApplicationPropertiesHolder.dispose(app);
    ...
    public void testTypeWithStreamNotRequiredTypeEquals() throws Exception {
        ...
        Object actual = typeMapper.mapToType(context, parameter, InputStream.class, null);
    ...
    public void testTypeWithBytes() throws Exception {
        ...
        byte[] actual = (byte[]) typeMapper.mapToType(context, multipartFile, byte[].class, null);
    ...
    public void testTypeWithMultipartParameters() throws Exception {
        ...
        MultipartParameters actual = (MultipartParameters) typeMapper.mapToType(context,
                parameters, MultipartParameters.class, null);
    ...
    public void testTypeWithMultipartParametersNotRequiredTypeEquals() throws Exception {
        MultipartFile multipartFile = mock(MultipartFile.class);
        Object actual = typeMapper.mapToType(context, multipartFile, MultipartParameters.class,
                null);
        assertThat(actual, is(nullValue()));
    }
