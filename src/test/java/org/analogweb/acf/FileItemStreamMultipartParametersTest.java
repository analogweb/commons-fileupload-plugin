...
public class FileItemStreamMultipartParametersTest {
    ...
    public void testIterator() throws Exception {
        ...
        final FileItemStream file1 = mock(FileItemStream.class);
        final FileItemStream file2 = mock(FileItemStream.class);
        final FileItemStream file3 = mock(FileItemStream.class);
        final FileItemStream file4 = mock(FileItemStream.class);
        final FileItemStream param1 = mock(FileItemStream.class);
        final FileItemStream param2 = mock(FileItemStream.class);
        final FileItemStream param3 = mock(FileItemStream.class);
        final FileItemStream param4 = mock(FileItemStream.class);
        ...
        final Iterator<FileItemStreamMultipart> actual = parameters.iterator();
    ...
    public void testGetParameter() throws Exception {
        ...
        assertNull(actual);
        final Collection<String> names = parameters.getParameterNames();
    ...
    public void testGetFiles() throws Exception {
        ...
        assertNull(actual);
        final Collection<String> names = parameters.getMultipartParameterNames();
        assertThat(names.size(), is(2));
