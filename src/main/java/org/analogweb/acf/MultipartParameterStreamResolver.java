 ...
 * @author snowgooseyk
 */
public class MultipartParameterStreamResolver extends
	...
	protected <T extends Multipart> MultipartParameters<T> createMultipartParameters(
		...
		return (MultipartParameters<T>)new FileItemStreamMultipartParameters(fileUpload.getItemIterator(context), resolvedEncoding);
	}
